...
import { generateWallpaper, validateApiKey } from './services/gemini';
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className={`w-full bg-black/50 border rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-white/30 ${
                      keyValidationStatus === 'invalid' ? 'border-red-500/50' : 
                      keyValidationStatus === 'valid' ? 'border-green-500/50' : 
                      'border-white/10'
                    }`}
                  />
                ...
                <button
                  ...
                  className="w-full py-2 rounded-lg bg-white text-black text-xs font-medium hover:bg-white/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isValidatingKey ? (
                    <>
